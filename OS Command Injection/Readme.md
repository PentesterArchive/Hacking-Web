...
If we go to or own system we can try to execute a script and see what happen if we execute it using some operators with another command behind:
...
***We can use those methods to obtain all the sistem info that we need or even to get a reverse shell:***
